          ...
          <div class="bg-white widget border rounded">
            ...
            <form action="php/consulta.php" class="form-contact-agent" method="GET">
              ...
              <div class="form-group">
                ...
                <hr>
                <a target="_blank" class="btn btn-whatsapp" href="https://api.whatsapp.com/send?text=Visita https://www.rodriguezgualda.com.ar/detalle-inmueble.php?idInmueble=<?PHP echo $_REQUEST['idInmueble']; ?>"><span class="icon-whatsapp"></span>&nbsp;Compartir en WhatsApp</a>
              </div>
            </form>
          </div>
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="mb-5">
              ...
              <p>Rodriguez Gualda Inmobiliaria nació como un estudio profesional, con el objetivo de jerarquizar y profesionalizar la actividad inmobiliaria en San Juan. Fue fundada por una Contadora Pública Nacional y un Licenciado en Administración y Corredor Inmobiliario, quienes aportaron su experiencia y formación para crear un espacio basado en procedimientos claros, estándares de calidad y un trabajo serio y responsable.</p>
            </div>
          </div>
